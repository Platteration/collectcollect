...
import { addAcquisition, createCard, getCard, updateCard } from "@/lib/cards";
...
const create = () => createCard({ game: "pokemon", name: "Lot correction", quantity: 2, purchasePrice: 10 });
const read = getCard;
